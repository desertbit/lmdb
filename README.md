...
####lmdb [![GoDoc](https://godoc.org/github.com/desertbit/lmdb/lmdb?status.svg)](https://godoc.org/github.com/desertbit/lmdb/lmdb) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/desertbit/lmdb/lmdb"
```

Core bindings allowing low-level access to LMDB.

####lmdbscan [![GoDoc](https://godoc.org/github.com/desertbit/lmdb/lmdbscan?status.svg)](https://godoc.org/github.com/desertbit/lmdb/lmdbscan) [![stable](https://img.shields.io/badge/stability-stable-brightgreen.svg)](#user-content-versioning-and-stability)

```go
import "github.com/desertbit/lmdb/lmdbscan"
```
...
####exp/lmdbpool [![GoDoc](https://godoc.org/github.com/desertbit/lmdb/exp/lmdbpool?status.svg)](https://godoc.org/github.com/desertbit/lmdb/exp/lmdbpool) [![experimental](https://img.shields.io/badge/stability-experimental-red.svg)](#user-content-versioning-and-stability)


```go
import "github.com/desertbit/lmdb/exp/lmdbpool"
```
...
####exp/lmdbsync [![GoDoc](https://godoc.org/github.com/desertbit/lmdb/exp/lmdbsync?status.svg)](https://godoc.org/github.com/desertbit/lmdb/exp/lmdbsync) [![experimental](https://img.shields.io/badge/stability-experimental-red.svg)](#user-content-versioning-and-stability)


```go
import "github.com/desertbit/lmdb/exp/lmdbsync"
```
...
[documentation](https://godoc.org/github.com/desertbit/lmdb/lmdb) so they are
...
[documentation](https://godoc.org/github.com/desertbit/lmdb/exp/lmdbsync) for
...
[issue](https://github.com/desertbit/lmdb/issues/1).
...
of lmdb.  In addition to [godoc](https://godoc.org/github.com/desertbit/lmdb)
...
- Its simpler design and implementation in pure Go mean it is free of many
  ...
  [documentation](https://godoc.org/github.com/desertbit/lmdb/lmdb).
...
`go get github.com/desertbit/lmdb/lmdb`
...
[godoc.org](https://godoc.org/github.com/desertbit/lmdb) is the primary source
